  ...
  function renderDashboard() {
    ...
    if (vencRows.length) {
      ...
      for (var pi = 0; pi < vencRows.length; pi++) {
        ...
        pySvg += '<text x="' + cx + '" y="' + (y + segH / 2 + 2).toFixed(1) + '" text-anchor="middle" fill="#fff" font-size="17" font-weight="700" font-family="system-ui,sans-serif">' + vencRows[pi].value + ' (' + pctVal + '%)</text>';
        var labelY = y + segH / 2;
